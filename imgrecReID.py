...
xmlpath = "E:/dataset/NJUST-MainRoad/Record/NJUST-MainRoad/results/20181022/ReID/"
outpath = "E:/dataset/NJUST-MainRoad/Record/NJUST-MainRoad/images/fivecams/20181022/ReID/"
...
for name in os.listdir(xmlpath):
    if os.path.splitext(name)[1] == ".xml":
        ...
        for object in objects:
            ...
            if objectname[-1].isdigit():
                img1 = cv2.putText(img, objectname, (int(xmin.childNodes[0].data), int(ymin.childNodes[0].data)),
                                   cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)
                cv2.rectangle(img1, (int(xmin.childNodes[0].data), int(ymin.childNodes[0].data)),
                              (int(xmax.childNodes[0].data), int(ymax.childNodes[0].data)), (0, 0, 255), 1)
        if reidnum > 0:
